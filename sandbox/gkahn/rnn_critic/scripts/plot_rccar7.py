...
all_exps = [load_experiments(range(i, i + 2)) for i in range(73, 80, 2)]
...
f_cumreward, axes_cumreward = plt.subplots(2, 2, figsize=(10, 10), sharey=True, sharex=True)
f_distance, axes_distance = plt.subplots(2, 2, figsize=(10, 10), sharey=True, sharex=True)
f_coll, axes_coll = plt.subplots(2, 2, figsize=(10, 10), sharey=True, sharex=True)
...
f_cumreward.savefig(os.path.join(SAVE_FOLDER, 'rccar7_cumreward.png'), bbox_inches='tight', dpi=150)
f_distance.savefig(os.path.join(SAVE_FOLDER, 'rccar7_distance.png'), bbox_inches='tight', dpi=150)
f_coll.savefig(os.path.join(SAVE_FOLDER, 'rccar7_coll.png'), bbox_inches='tight', dpi=150)
