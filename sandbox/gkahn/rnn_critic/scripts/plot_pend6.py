...
exps_list = [load_experiments(range(i, i+3)) for i in list(range(996, 1031, 3))]
...
# plt.tight_layout()
f.savefig(os.path.join(SAVE_FOLDER, 'pend6_comparison.png'), bbox_inches='tight', dpi=150)
plt.close(f)
