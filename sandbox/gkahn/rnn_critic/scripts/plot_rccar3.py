...
f_cumreward.savefig(os.path.join(SAVE_FOLDER, 'rccar3_cumreward.png'), bbox_inches='tight', dpi=150)
f_distance.savefig(os.path.join(SAVE_FOLDER, 'rccar3_distance.png'), bbox_inches='tight', dpi=150)
