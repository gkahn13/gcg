...
dqn_5_wb = load_experiments([34, 35, 36])
dqn_5_et = load_experiments([37, 38, 39])
dqn_10_wb = load_experiments([41, 42])
dqn_10_et = load_experiments([43, 45])
...
# plt.tight_layout()
f.savefig(os.path.join(SAVE_FOLDER, 'tennis1_comparison.png'), bbox_inches='tight', dpi=300)
plt.close(f)
