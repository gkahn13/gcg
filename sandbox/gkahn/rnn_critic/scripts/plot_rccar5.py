...
all_exps = [load_experiments(range(i, i+3)) for i in [43, 46]]
...
f_cumreward.savefig(os.path.join(SAVE_FOLDER, 'rccar5_cumreward.png'), bbox_inches='tight', dpi=150)
f_distance.savefig(os.path.join(SAVE_FOLDER, 'rccar5_distance.png'), bbox_inches='tight', dpi=150)
