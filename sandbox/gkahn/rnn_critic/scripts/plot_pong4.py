...
all_exps = [load_experiments(range(i, i+3)) for i in list(range(1031, 1174, 3))]
...
for i, exps in enumerate(list(np.array_split(all_exps, 2))):
    ...
    f_cumreward.savefig(os.path.join(SAVE_FOLDER, 'pong4_{0:02d}_comparison.png'.format(i)), bbox_inches='tight', dpi=150)
