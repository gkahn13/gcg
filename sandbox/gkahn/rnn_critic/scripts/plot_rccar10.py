...
all_exps = [load_experiments(range(i, i + 3)) for i in list(range(118, 126, 3)) + list(range(99, 116, 3))]
...
f_cumreward, axes_cumreward = plt.subplots(3, 3, figsize=(15, 15), sharey=False, sharex=True)
f_distance, axes_distance = plt.subplots(3, 3, figsize=(15, 15), sharey=True, sharex=True)
f_coll, axes_coll = plt.subplots(3, 3, figsize=(15, 15), sharey=True, sharex=True)
f_value, axes_value = plt.subplots(3, 3, figsize=(15, 15), sharey=False, sharex=True)
...
f_cumreward.savefig(os.path.join(SAVE_FOLDER, 'rccar10_cumreward.png'), bbox_inches='tight', dpi=150)
f_distance.savefig(os.path.join(SAVE_FOLDER, 'rccar10_distance.png'), bbox_inches='tight', dpi=150)
f_coll.savefig(os.path.join(SAVE_FOLDER, 'rccar10_coll.png'), bbox_inches='tight', dpi=150)
f_value.savefig(os.path.join(SAVE_FOLDER, 'rccar10_value.png'), bbox_inches='tight', dpi=150)
