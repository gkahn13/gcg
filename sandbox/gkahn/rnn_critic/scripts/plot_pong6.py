...
all_exps = [load_experiments(range(i, i+3)) for i in list(range(1321, 1332, 3))]
...
exps = all_exps
f_cumreward, axes_cumreward = plt.subplots(4, 1, figsize=(3, 12), sharey=True, sharex=True)
...
f_cumreward.savefig(os.path.join(SAVE_FOLDER, 'pong6_comparison.png'), bbox_inches='tight', dpi=150)
