...
all_exps = [load_experiments(range(i, i + 3)) for i in range(453, 479, 3)]
...
f_cumreward.savefig(os.path.join(SAVE_FOLDER, 'rccar12_cumreward.png'), bbox_inches='tight', dpi=150)
f_distance.savefig(os.path.join(SAVE_FOLDER, 'rccar12_distance.png'), bbox_inches='tight', dpi=150)
f_coll.savefig(os.path.join(SAVE_FOLDER, 'rccar12_coll.png'), bbox_inches='tight', dpi=150)
f_value.savefig(os.path.join(SAVE_FOLDER, 'rccar12_value.png'), bbox_inches='tight', dpi=150)
