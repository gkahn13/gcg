...
all_exps = [load_experiments(range(i, i + 2)) for i in (87, 89)]
...
f_distance, axes_distance = plt.subplots(1, 2, figsize=(10, 5), sharey=True, sharex=True)
f_coll, axes_coll = plt.subplots(1, 2, figsize=(10, 5), sharey=True, sharex=True)
...
f_cumreward.savefig(os.path.join(SAVE_FOLDER, 'rccar9_cumreward.png'), bbox_inches='tight', dpi=150)
f_distance.savefig(os.path.join(SAVE_FOLDER, 'rccar9_distance.png'), bbox_inches='tight', dpi=150)
f_coll.savefig(os.path.join(SAVE_FOLDER, 'rccar9_coll.png'), bbox_inches='tight', dpi=150)
